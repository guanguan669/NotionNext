...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'guan的精神世界', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个人走了很久', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'xiaog.asia', // 网站地址
